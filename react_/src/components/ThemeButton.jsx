...
function ThemeButton({ toggleDarkMode }) {
    const [isDarkIconVisible, setDarkIconVisible] = useState(true);

    const toggleIcon = () => {
        setDarkIconVisible((prevValue) => !prevValue);
    };
    ...
    return (
        ...
        >
            <svg
                ...
                className={`w-5 h-5 ${isDarkIconVisible ? "block" : "hidden"}`}
                fill="currentColor"
                viewBox="0 0 20 20"
